...
/**
 * Created by Dylan on 2014-03-24.
 */
public class Transform {

    private static Camera camera;

    private static float zNear;   // How close a object has to be to us before it clips
    private static float zFar;    // How far something can be before being clipped
    ...
    public Matrix4f getTransformation() {
        Matrix4f translationMatrix = new Matrix4f().initTranslation(this.translation.getX(), this.translation.getY(), this.translation.getZ());
